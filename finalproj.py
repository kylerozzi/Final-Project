...
if q1 == "N":
    ...
    q2 = input("In the cave there is a lantern. Do you pick it up?  Enter “Y” for yes and “N” for no: ")
    if q2 == "N":
        print("You’re in a dark cave and you don’t pick up a lantern - smart move: GAME OVER")
    elif q2 == "Y":
        q3 = input("You pickup the lantern and continue walking. At some point, you catch sight of a sword and a gold brick sitting next to one another on the ground. You can only take one. Enter “S” for sword and “G” for the gold brick: ")
        if q3 == "G":
            q4 = input("You proceed further into the cave. At some point, you catch sight of a door being guarded by sleeping wolf. You can either decide to turn around and go back or quietly go past the wolf through the door: Enter “T” for turn around and “Q” for quietly going past: ")
            if q4 == "T":
                ...
                if q5 == "B":
                    ...
                    if q6 == "P":
                        q7 = input("You enter the room. Enter “Y” to take the puppy home and “N” to leave empty handed: ")
                        if q7 == "N":
                        ...
                        q8 = input("You enter the room. Enter “Y” to take the treasure and “N” to leave empty handed: ")
                        if q8 == "N":
                            print("You want to end your adventure empty handed? Well, it's your prerogative - Thank you for playing: The End")
                        elif q8 == "Y":
            ...
            q9 = input("Sword at your side, you proceed further into the cave. At some point, you catch sight of a door being guarded by sleeping wolf. You can either decide to turn around and go back or quietly go past the wolf through the door: Enter “T” for turn around and “Q” for quietly going past: ")
            if q9 == "T":
                print("You are a coward: GAME OVER")
            elif q9 == "Q":
                ...
                if q10 == "A":
                    ...
                    if q11 == "P":
                        q12 = input("You enter the room. Enter “Y” to take the puppy home and “N” to leave empty handed: ")
                        if q12 == "N":
                            print("You want to end your adventure empty handed? Well, it's your prerogative - Thank you for playing: The End")
                        elif q12 == "Y":
                            print("Fantastic decision. You take home the puppy and end up with a great companion. A successful adventure, I’d say: The End")
                        ...
                        q13 = input("You enter the room. Enter “Y” to take the treasure and “N” to leave empty handed: ")
                        if q13 == "N":
                            print("You want to end your adventure empty handed? Well, it's your prerogative - Thank you for playing: The End")
                        elif q13 == "Y":
                            print("Fantastic decision. You take home the treasure and find yourself incredibly rich. A successful adventure, I’d say: The End")
